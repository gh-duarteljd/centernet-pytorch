...
def get_map(MINOVERLAP, draw_plot, score_threhold=0.5, path = './map_out'):
     ...
     if show_animation:
         os.makedirs(os.path.join(RESULTS_FILES_PATH, "images", "detectionns_one_by_one"))
     ...
     with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
         ...
         if n_classes == 0:
             print("No category detected, please check whether the label information and classes_path in get_map.py have been modified.")
             return 0
         results_file.write("\n# mAP of all classes\n")
     ...
     # """
     # Plot the total number of occurrences of each class in the "detection-results" folder
     # """
     # if draw_plot:
...
def preprocess_gt(gt_path, class_names):
     ...
     for i, image_id in enumerate(image_ids):
         ...
         # Solved the problem of 'Results do not correspond to current coco set'
         #------------------------------------------------- ----------------#
