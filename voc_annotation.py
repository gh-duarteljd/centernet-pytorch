...
# annotation_mode is 0 to represent the entire label processing process, including obtaining the txt in VOCdevkit/VOC2007/ImageSets and 2007_train.txt and 2007_val.txt for training
# annotation_mode is 1 to get the txt in VOCdevkit/VOC2007/ImageSets
# annotation_mode is 2 means to get 2007_train.txt and 2007_val.txt for training
#------------------------------------------------- -------------------------------------------------- -----------------------------#
annotation_mode = 0
#------------------------------------------------- ------------------#
# Must be modified to generate target information for 2007_train.txt and 2007_val.txt
# Just match the classes_path used for training and prediction
...
if __name__ == "__main__":
     ...
     if " " in os.path.abspath(VOCdevkit_path):
         raise ValueError("There must be no spaces in the folder path where the data set is stored and in the picture name, otherwise it will affect the normal model training, please pay attention to modify.")
     ...
     if annotation_mode == 0 or annotation_mode == 2:
         ...
         if np.sum(nums) == 0:
             print("I didn't get any target in the data set, please pay attention to modify the classes_path to correspond to your own data set, and ensure that the label name is correct, otherwise the training will have no effect!")
             print("I didn't get any target in the data set, please pay attention to modify the classes_path to correspond to your own data set, and ensure that the label name is correct, otherwise the training will have no effect!")
             print("I didn't get any target in the data set, please pay attention to modify the classes_path to correspond to your own data set, and ensure that the label name is correct, otherwise the training will have no effect!")
