...
#------------------------------------------------- ----------------#
# Use Renset50 as the backbone feature extraction network, and finally get a
# Effective feature layer of 16x16x2048
#------------------------------------------------- ----------------#
...
class resnet50_Decoder(nn.Module):
     def __init__(self, inplanes, bn_momentum=0.1):
         ...
         # Utilize ConvTranspose2d for upsampling.
...
class resnet50_Head(nn.Module):
     def __init__(self, num_classes=80, channel=64, bn_momentum=0.1):
         ...
         #------------------------------------------------- ----------------#
         #Upsample the acquired features for classification prediction and regression prediction
         # 128, 128, 64 -> 128, 128, 64 -> 128, 128, num_classes
         # -> 128, 128, 64 -> 128, 128, 2
         # -> 128, 128, 64 -> 128, 128, 2
         #------------------------------------------------- ----------------#
         # Heat map prediction part
         ...
         # Part of the center point prediction
